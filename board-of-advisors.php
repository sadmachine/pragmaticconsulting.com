...
<head>
  ...
  <title>Board of Advisors - Pragmatic Consulting, Inc.</title>
  <meta name="description" content="Get familiar with the key players behind Pragmatic Consulting's success. Our board of advisors features executive level talent in a wide range of manufacturing and other industry consulting.">
</head>
  ...
  <div class="container-fluid">
    ...
    <section id="content" class="row justify-content-center">
      <main class="col-12 col-md-11 col-xl-9 p-3 p-sm-4">
        <h2 class="content-title mb-3">Board of Advisors</h2>
        <div class="row mx-5 mx-md-3 mx-lg-1 officer-list justify-content-center">
          ...
          <?php displayProfile("richard_penn.jpg", 'richardpenn', "Richard Penn", "Principal Partner"); ?>
          <?php displayProfile("bio_Pascal_Orliac.jpg", 'pascalorliac', "Pascal Orliac", "Advisor"); ?>
          <?php displayProfile("bio_gaynor.jpg", 'paulgaynor', "Paul Gaynor", "Advisor"); ?>
        </div>
