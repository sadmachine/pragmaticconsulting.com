            ...
            <section class="card" data-aos="fade-up">
                <div class="card-body">
                    <figure class="d-block d-lg-none w-100 mx-auto mb-3">
                        <img class="img-fluid" src="img/erp/epicor-interface.png"
                             alt="Epicor 10 Interface" />
                        <figcaption>Epicor Kinetic Main Environment</figcaption>
                    </figure> <!-- .d-(block|lg-none) .w-100 .m(x-auto|b-3) -->
                    <div class="media">
                        <div class="media-body text-justify">
                            <p class="lead">
                                As an 
                                <a href="https://www.epicor.com/en-us/partners/channel-partners/find-a-partner/pragmatic-consulting/" target="_blank" rel="noopener noreferrer">Epicor Certified Service Provider</a>
                                our IT and Systems experts possess extensive experience successfully implementing
                                <strong>Epicor Kinetic</strong> and many related ERP projects. Pragmatic has many years of
                                ...
                                <a href="/prophet-21.php">Prophet 21</a>, and BisTrack.
                            </p>
                        ...
                        <figure class="d-none d-lg-inline-block w-40 ml-4 align-self-center">
                            <img class="img-fluid" src="img/erp/epicor-interface.png"
                                 alt="Epicor 10 Interface" />
                            <a href="https://www.epicor.com/en-us/partners/channel-partners/find-a-partner/pragmatic-consulting/" 
                               class="d-block mt-2 px-2 py-1 img-link">
                                <img class="img-fluid" src="img/erp/epicor-certified-partner.png"
                                    data-toggle="tooltip" data-placement="bottom"
                                    title="Epicor Certified Partner Listing"
                                    alt="Epicor Certified Partner" />
                            </a>
