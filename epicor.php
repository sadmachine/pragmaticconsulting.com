...
$content_id = 'epicor';
$content_title = 'Epicor ERP Software';
                ...
                <div class="card-body">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>
                                If you are considering a <strong>full-service</strong> solution, Epicor should be on your
                                list and is a
                                viable solution in
        ...
        <div class="col-12">
            <section class="card" data-aos="fade-up">
                ...
                <div class="card-body">
                    <div class="row">
                        <p class="col-12">
                            <strong>Epicor</strong> is a state of the art fully integrated <em>ERP</em> (Enterprise Resource
                            Planning)
