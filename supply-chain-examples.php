  ...
  <div class="container-fluid">
    ...
    <section id="content" class="row justify-content-center">
      <main class="col-12 col-md-11 col-lg-9 p-3 p-sm-4">
        ...
        <img src="img/scwm1.png" alt="" style="width: 100%; height: 750px;"  />
        ...
        <div class="row justify-content-around">
          <blockquote class="blockquote testimonial col-12 col-lg-5">
            <p class="mb-0">Thanks to the help of the Pragmatic Consulting team, our process is running more efficiently than ever before</p>
            <footer class="blockquote-footer">Paul Hurtig <cite title="Vice President of Operations">Vice President of Operations</cite></footer>
          </blockquote>
          <blockquote class="blockquote testimonial col-12 col-lg-5">
            <p class="mb-0">We never could have done this project without Pragmatic </p>
            <footer class="blockquote-footer">Russ Grenier <cite title="Facilities Manager">Facilities Manager</cite></footer>
          </blockquote>
        </div>
        ...
        <div class="row justify-content-between align-items-center">
          ...
          <div class="col-12 col-sm-4">
            <a href="http://www.valutrack.com/"> <img src="img/logos/Valutrack-logo.png" alt="ValuTrack" class="img-fluid" style="text-align: right;" /></a>
          </div>
        </div>
