  ...
  <div class="container-fluid">
    ...
    <section id="content" class="row justify-content-center">
      <main class="col-12 col-md-11 col-lg-9 p-3 p-sm-4">
        ...
        <ul>
          <li><a href="lean-implementation-ge.php">Lean Implementation Project - General Electric Co.</a></li>
          <li><a href="lean-implementation-berkshire.php">Lean Implementation Project - Berkshire Manufactured Products</a></li>
        </ul>
      </main>
    </section>
