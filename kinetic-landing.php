...
$content_id = 'epicor';
$content_title = 'Epicor Kinetic ERP Software';
...
?>
  <div class="row">
    <div class="col-12 hero-content">
      <div>
        <h1>Epicor Kinetic ERP Software</h1>
        <p class="lead">
            Transform Your Manufacturing Business with Epicor Kinetic Expertise & Consulting Services
        </p>
    ...
    <div class="row">
        <div class="col">
            <section class="card" data-aos="fade-up">
                <div class="card-body">
                    <h3>Is your manufacturing business ready to scale but held back by outdated systems or inefficient processes?</h3>
                    <p>
                        At Pragmatic Consulting, Inc., we specialize in
                        <strong>Epicor manufacturing consulting,
                        implementations, and training</strong>, helping
                        manufacturers streamline operations, improve inventory
                        control, and boost profitability.
                    </p>
                    <p>
                        Whether you're upgrading, migrating to the cloud, or
                        starting fresh, our Epicor certified consultants bring
                        deep industry knowledge and hands-on experience to
                        ensure a smooth, successful deployment tailored to your
                        business goals
                    </p>
                    ...
                    <ul>
                      <li>Certified Epicor Kinetic Experts</li>
                      <li>Deep Manufacturing Industry Experience</li>
                    ...
                    <ul>
                      <li>End-to-end Epicor ERP implementation</li>
                      <li>System customization & integration</li>
                      <li>Data migration & validation</li>
                      <li>Cloud Implementations</li>
                      <li>User training & ongoing support</li>
                      <li>Manufacturing & Distribution expertise</li>
                      <li>Performance optimization & reporting</li>
                    </ul>

                    <strong>Ready to transform your operations?</strong>
                    <p>
                      Let's talk about how Epicor Kinetic can elevate your business.
                    </p>
        ...
        <div class="col-12 col-lg-5 sticky-top">
            <section class="card form-style-8" data-aos="fade-up">
                <div class="card-body">
                    ...
                    <p>
                      Looking to modernize your manufacturing operations? Let's explore how Epicor Kinetic can streamline your processes and position your business for long-term success.
                    </p>
            ...
            <section class="card" data-aos="fade-up">
                ...
                <div class="card-body">
                    <figure class="d-block d-md-none w-100 w-sm-65 mx-auto mb-3">
                        <img class="img-fluid" src="img/erp/MES-interface.png"
                             alt="Epicor MES Interface" />
                        <figcaption>Epicor Kinetic MES (Manufacturing Execution System) Environment</figcaption>
                    </figure>
                    <div class="media">
                        ...
                        <div class="media-body">
                            <p>
                                <span class="text-prag">Pragmatic's</span> broad implementation proficiency allows us to
                                get the most
                                out of
                                your investment with a <strong>Total Systems</strong> approach throughout the extended
                                supply chain from
                                forecasting, <em>quote to cash</em>, and beyond. Thus, whether it be planning and
                                scheduling, the MES
                                module,
                                ...
                                you improve your information technology as well as your operations and business environment
                                as a whole.
                            </p>
                            <p>
                                If you are considering a <strong>full-service</strong> solution, Epicor Kinetic should be on your
                                list and is a
                                viable solution in
                                many cases. Indeed, we have put together cross functional teams that incorporate
                                <em>Lean</em> techniques
                                as well
                                as throughout the entire enterprise for maximum optimization. Whether you are a large or
                                small
                                organization, we provide customized expert advice and guidance through these processes to
                                <strong>maximize
                                    success</strong>.
                                This, coupled with our breadth of manufacturing and distribution expertise is something hard
                                to find
        ...
        <div class="col-12">
            <section class="card" data-aos="fade-up">
                ...
                <div class="card-body">
                    <div class="row">
                        <p class="col-12">
                            <strong>Epicor Kinetic</strong> is a state of the art fully integrated <em>ERP</em> (Enterprise Resource
                            Planning)
