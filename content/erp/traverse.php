<p>At Pragmatic we are experienced in Class A ERP implementation. Our consultants range from APICS certified applications expert to software developers along with Manufacturing and Distribution experts. We have successfully advised and coached
  clients through the selection process, as well as performed "hands on" implementations of various Epicor products and modules. We are not a VAR nor do we peddle any software. This gives us an unbiased approach to the best software and features
...
<p>Traverse is a Global ERP System built by Open Systems. Module based and affordable, Traverse is used by companies large and small, in industries spanning from food to nonprofits. Because Traverse is module based, software implementations range
  from accounting, distribution, manufacturing, to entire businesses.</p>

<p>For more information on our Traverse services, please visit our <a href="contact.php">contact page</a>.</p>
