...
<head>
  ...
  <title>IQMS - Pragmatic Consulting, Inc.</title>
  <meta name="description" content="Implement IQMS properly with the help of Pragmatic Consulting, Inc. We help fully utilize the large range of tools IQMS offers into your organization.">
</head>
  ...
  <div class="container-fluid">
    ...
    <section id="content" class="row justify-content-center">
      <main class="col-12 col-md-11 col-lg-9 p-3 p-sm-4">
        <h2 class="content-title">IQMS</h2>
