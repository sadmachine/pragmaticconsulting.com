...
<head>
  ...
  <title>Microsoft Dynamics - Pragmatic Consulting, Inc.</title>
  <meta name="description" content="Implement Microsoft Dynamics properly with the help of Pragmatic Consulting, Inc. We help fully utilize the large range of tools Dynamics offers your organization.">
</head>
  ...
  <div class="container-fluid">
    ...
    <section id="content" class="row justify-content-center">
      <main class="col-12 col-md-11 col-lg-9 p-3 p-sm-4">
        <h2 class="content-title">Microsoft Dynamics</h2>
        <?php require 'content/erp/dynamics.php'; ?>
      </main>
    </section>
