      ...
      <section id="content" class="row justify-content-center">
        <main class="col-12 col-md-11 col-xl-9 p-3 p-sm-4">
          ...
          <div class="row mx-5 mx-md-3 mx-lg-1 officer-list justify-content-center">
            <?php displayProfile("russ.jpg", 'russellsnyder', "Russell Snyder", "ERP Implementation & Training"); ?>
            <?php displayProfile("richard_penn.JPG", 'richardpenn', 'Richard Penn', 'Project Manager'); ?>
            <?php displayProfile("afishbaugh.jpg", 'austinfishbaugh', "Austin Fishbaugh", "IT & Applications Consultant"); ?>
            ...
            <?php displayProfile("hingram.jpg", 'haroldingram', "Harold Ingram", "Epicor Consultant"); ?>
            <?php displayProfile("wmalcolm.jpg", 'billmalcolm', "Bill Malcolm", "Project Manager & Senior Dynamics Consultant"); ?>           
            ...
            <?php displayProfile("ltracy.jpg", 'elizabethtracy', "Elizabeth Tracy", "Quality Management Consultant"); ?>
             ...
             <?php displayProfile("dderkacs.jpg", 'dougderkacs', "Doug Derkacs", "Application Support & Ecommerce Systems Analyst"); ?>
             ...
             <?php displayProfile("lberry.png", 'laylaberry', "Layla Berry", "Prophet 21 Application & Implementation Consultant"); ?>
             <?php displayProfile("terblue.jpg", 'terrenceblue', "Terrence Blue", "Prophet 21 Implementation Consultant & Project Manager"); ?>
          </div>
