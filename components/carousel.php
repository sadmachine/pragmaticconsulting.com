...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="3500">
  <div class="carousel-inner">
    ...
    carousel_item('img/carousel/12.jpg', 'Pharmaceutical');
    carousel_item('img/carousel/13.jpg', 'Food & Food Service Industry');
    carousel_item('img/carousel/14.jpg', 'Industrial Equipment & More!', false, false);
    ?>
  </div>
