  ...
  <div class="row  py-3  justify-content-center">
    <div class="col-auto  text-center">
      <p>
        ...
        <a href="mailto:sales@pragmaticconsulting.com" class="fas  fa-envelope  bg-prag-red  text-white"></a>
        <a href="tel:+16034314461" class="fas  fa-phone  bg-prag-red  text-white"></a>
      </p>
      <p>
        <strong>Phone:</strong> (603) 431-4461
        <br />
        <strong>Email:</strong> inquiries@pragmaticconsulting.com
      </p>
    </div>
  </div>
